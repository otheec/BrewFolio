const PlaceholderIcon = () => (
    <svg className="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" fill="#007bff" role="img" aria-label="Placeholder: 32x32" preserveAspectRatio="xMidYMid slice" focusable="false">
...
const BrandLogo = () => (
  ...
  <g>
    <g>
      <g>
        <circle fill="#C63C22" cx="148.5" cy="148.5" r="148.5"/>
      </g>
    </g>
    <path fill="#9E231D" d="M296.703,139.216l-96.66-96.678L95.112,242.358l54.626,54.626C231.181,296.318,297,230.1,297,148.5
      C297,145.381,296.892,142.288,296.703,139.216z"/>
    <g>
      <path fill="#FFFFFF" d="M207.444,99.107c9.143,0,16.556-7.412,16.556-16.556s-7.412-16.556-16.556-16.556
    ...
    <g>
      <path fill="#D0D5D9" d="M207.444,65.996c-0.233,0-0.459,0.025-0.689,0.035c0.446-1.863,0.689-3.805,0.689-5.804
    ...
    <g>
      <path fill="#F0DEB4" d="M238.282,115.5H206.25v-33H90.75v148.792c0,8.952,7.257,16.208,16.208,16.208h83.083
    ...
    <g>
      <path fill="#D8C49C" d="M238.282,115.5H206.25v-33h-57.583v165h41.375c8.952,0,16.208-7.257,16.208-16.208V198h32.032
    ...
    <g>
      <path fill="#FFA800" d="M111.814,237.857h73.372c7.905,0,14.314-6.409,14.314-14.314v-92.4h-102v92.4
        C97.5,231.449,103.909,237.857,111.814,237.857z"/>
    </g>
    <g>
      <path fill="#CE8400" d="M148.667,131.143v106.714h36.519c7.905,0,14.314-6.409,14.314-14.314v-92.4H148.667z"/>
    </g>
  </g>
  </svg>
);
  
export { PlaceholderIcon, LinkIcon, BrandLogo, SearchIcon, EditIcon };
